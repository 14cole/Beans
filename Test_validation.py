...
1. PEC circular cylinder, TM polarization, multiple ka values
1. PEC strip (flat plate), TE polarization, broadside
1. Mesh convergence: PEC cylinder at ka=5 across three mesh densities
   “””
